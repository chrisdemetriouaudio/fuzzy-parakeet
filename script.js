...
if (menuBtn && navLinks) {
    ...
    // ─── 8. Ticker — stationary, slow crawl on hover, freezes in place on leave ──
    (function () {
        ...
        // Create a Web Animations API animation for each ticker
        // This gives us direct .play() / .pause() control with guaranteed position hold
